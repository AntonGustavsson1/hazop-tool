...
en och samma kryssbara lista med namn, RRF och närvaro; ikryssning lägger
till dem på aktuell konsekvens och avmarkering tar bort just den kopplingen.
...
Backventil har därefter förenklats till `Backventil fastnar stängd` med
...
Filter / sil har därefter förenklats till `Filter / sil igensatt` och
`Filter / sil skadat`, båda med 0,01/år.
